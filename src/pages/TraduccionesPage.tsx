...
import { motion, AnimatePresence } from 'framer-motion'; // Re-enabled motion
...
function TraduccionesPage() {
    ...
    // Update selectedTags if URL parameter changes (unchanged)
    ...
    // --- MODIFIED: Added "TV Short" ---
    const formatTags = ["TV", "TV Short", "OVA", "Especial", "Película"]; // Added "TV Short"
    // --- END MODIFICATION ---
    ...
    // Simple Spinner Component - Use Cyan (unchanged)
    ...
    // Helper function to render tag groups in filters - Use Cyan (unchanged)
    ...
    return (
        <>
            ...
            >
                ...
                {/* Page Title & Description - Use Cyan (Re-enabled motion) */}
                {/* Re-enabled motion.h1 with variants */}
                ...
                {/* Re-enabled motion.p with variants */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 xl:gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <motion.div variants={itemVariants} className="mb-12 p-6 bg-gradient-to-br from-gray-800/90 to-gray-900/80 rounded-xl border border-gray-700/50 shadow-xl backdrop-blur-sm">
                            {/* Search and Sort (unchanged structure) */}
                        ...
                        {/* Anchor for scrolling (unchanged) */}
